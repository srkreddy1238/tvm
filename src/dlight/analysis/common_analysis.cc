...
DlightIterInfo::DlightIterInfo(tvm::tir::IterVar iter, s_tir::LoopRV loop_rv) {
...
DlightSBlockInfo::DlightSBlockInfo(ffi::String name, ffi::Array<DlightIterInfo> iters,
                                   s_tir::SBlockRV block_rv, bool reduction_block) {
