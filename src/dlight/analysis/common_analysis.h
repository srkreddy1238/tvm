...
class DlightIterInfo : public runtime::ObjectRef {
 public:
  /*\brief  Constructor */
  DlightIterInfo(tvm::tir::IterVar iter, tir::LoopRV loop_rv);
...
class DlightSBlockInfo : public runtime::ObjectRef {
 public:
  /*\brief  Constructor */
  DlightSBlockInfo(ffi::String name, ffi::Array<DlightIterInfo> iters, tir::SBlockRV block_rv,
