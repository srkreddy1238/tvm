...
tir::PrimFunc AttentionPrefill(int64_t h_kv, int64_t h_q, int64_t d, const std::string& dtype,
  ...
  tir::Buffer pages_buf = tir::Buffer(
      ...
      dt, {max_num_pages, I32(2), I32(h_kv), I32(page_size), I32(d)}, {}, pages_eo,
  ...
  tir::Buffer q_rope_pos_buf = tir::Buffer(
      ...
      DataType::Int(32), {total_len}, {}, q_rope_pos_eo, "q_rope_position", 0, 0, tir::kDefault);
  ...
  tir::Buffer length_info_buf = DeclLengthInfo(h_length_info_h, batch_size, sliding_window, length_info_eo);
  ...
  Stmt q_load = tir::For(li_ql, I32(0), I32(tile_x), tir::ForKind::kSerial,
      tir::For(lj_ql, I32(0), I32(d), tir::ForKind::kSerial,
          tir::SBlockRealize({}, tir::const_true(),
              tir::SBlock({}, {}, {}, "Q_load",
                      ...
                      tir::LetStmt(cur_H_qo_ql,
                          ...
                          tir::IfThenElse(
                              ...
                              tir::BufferStore(Q_smem,
                                  BuildPrefillRopeExpr(q_buf, {cur_L_ql, cur_H_qo_ql}, lj_ql, d,
                              ...
                              tir::LetStmt(page_no_kl,
                                  ...
                                  tir::LetStmt(page_off_kl, floormod(seq_off_kl, I32(page_size)),
                                      tir::BufferStore(K_smem,
                                          BuildPrefillRopeExpr(pages_buf,
                                              {page_no_kl, I32(0), by, page_off_kl}, ly_kl, d,
                                              tir::BufferLoad(k_rope_pos_buf, {b_idx}) + cur_L_kl,
                                              rope_scale, rope_theta, rotary_mode, dtype, rope_scaling), ffi::Array<PrimExpr>{lz_kl, ly_kl})))),
  ...
  Stmt v_load = tir::For(lz_vl, I32(0), I32(tile_z), tir::ForKind::kSerial,
      tir::For(ly_vl, I32(0), I32(d), tir::ForKind::kSerial,
          tir::SBlockRealize({}, tir::const_true(),
              tir::SBlock({}, {}, {}, "V_load",
                  tir::LetStmt(cur_L_vl, L_kv_start + lz_vl,
                      tir::IfThenElse(cur_L_vl < ld0(kv_chunk_buf),
                          tir::LetStmt(seq_off_vl,
                              GetSeqOffset(cur_L_vl, b_idx, length_info_buf, sliding_window),
                              tir::LetStmt(page_no_vl,
                                  tir::BufferLoad(page_values_buf, ffi::Array<PrimExpr>{cur_begin + floordiv(seq_off_vl, I32(page_size))}),
                                  tir::LetStmt(page_off_vl, floormod(seq_off_vl, I32(page_size)),
                                      tir::BufferStore(V_smem,
                                          tir::BufferLoad(pages_buf, ffi::Array<PrimExpr>{page_no_vl, I32(1), by, page_off_vl, ly_vl}), ffi::Array<PrimExpr>{lz_vl, ly_vl})))),
  ...
  tir::IterVar iv_sg_k = tir::IterVar(Range(I32(0), I32(d)), tir::Var("k", DataType::Int(32)), tir::kCommReduce);
  ...
  tir::IterVar iv_og_j = tir::IterVar(Range(I32(0), I32(d)), tir::Var("j", DataType::Int(32)), tir::kDataPar);
  ...
  // Thread binding loops + axis remap via LetStmt
  ...
  ffi::Array<tir::Var> params = {
      ...
      h_length_info_h, h_k_rope_pos_h, h_q_rope_pos_h,
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef().def(
      "relax.frontend.nn.llm.kv_cache.attention_prefill",
