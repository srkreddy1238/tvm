...
@pytest.mark.parametrize(
    "net, shape",
    [
        (tf.keras.applications.Xception, (1, 299, 299, 3)),
        (tf.keras.applications.VGG16, (1, 224, 224, 3)),
        (tf.keras.applications.VGG19, (1, 224, 224, 3)),
        (tf.keras.applications.ResNet50, (1, 224, 224, 3)),
        (tf.keras.applications.ResNet50V2, (1, 224, 224, 3)),
        # (tf.keras.applications.ResNet101, (1, 224, 224, 3)),
        # (tf.keras.applications.ResNet101V2, (1, 224, 224, 3)),
        # (tf.keras.applications.ResNet152, (1, 224, 224, 3)),
        # (tf.keras.applications.ResNet152V2, (1, 224, 224, 3)),
        (tf.keras.applications.InceptionResNetV2, (1, 299, 299, 3)),
        (tf.keras.applications.MobileNet, (1, 224, 224, 3)),
        (tf.keras.applications.MobileNetV2, (1, 224, 224, 3)),
        (tf.keras.applications.DenseNet121, (1, 224, 224, 3)),
        # (tf.keras.applications.DenseNet169, (1, 224, 224, 3)),
        # (tf.keras.applications.DenseNet201, (1, 224, 224, 3)),
        # (tf.keras.applications.NASNetMobile, (1, 224, 224, 3)),
        (tf.keras.applications.NASNetLarge, (1, 331, 331, 3)),
        (tf.keras.applications.EfficientNetB0, (1, 224, 224, 3)),
        # (tf.keras.applications.EfficientNetB1, (1, 240, 240, 3)),
        # (tf.keras.applications.EfficientNetB2, (1, 260, 260, 3)),
        # (tf.keras.applications.EfficientNetB3, (1, 300, 300, 3)),
        # (tf.keras.applications.EfficientNetB4, (1, 380, 380, 3)),
        # (tf.keras.applications.EfficientNetB5, (1, 456, 456, 3)),
        # (tf.keras.applications.EfficientNetB6, (1, 528, 528, 3)),
        # (tf.keras.applications.EfficientNetB7, (1, 600, 600, 3)),
        (tf.keras.applications.EfficientNetV2B0, (1, 224, 224, 3)),
        # (tf.keras.applications.EfficientNetV2B1, (1, 240, 240, 3)),
        # (tf.keras.applications.EfficientNetV2B2, (1, 260, 260, 3)),
        # (tf.keras.applications.EfficientNetV2B3, (1, 300, 300, 3)),
        (tf.keras.applications.EfficientNetV2S, (1, 384, 384, 3)),
        # (tf.keras.applications.EfficientNetV2M, (1, 480, 480, 3)),
        # (tf.keras.applications.EfficientNetV2L, (1, 480, 480, 3)),
        (tf.keras.applications.ConvNeXtTiny, (1, 224, 224, 3)),
        # (tf.keras.applications.ConvNeXtSmall, (1, 224, 224, 3)),
        # (tf.keras.applications.ConvNeXtBase, (1, 224, 224, 3)),
        # (tf.keras.applications.ConvNeXtLarge, (1, 224, 224, 3)),
        # (tf.keras.applications.ConvNeXtXLarge, (1, 224, 224, 3)),
    ],
)
