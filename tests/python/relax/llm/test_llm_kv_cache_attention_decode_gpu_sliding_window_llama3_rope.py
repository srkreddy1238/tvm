...
# under the License.
"""Test for _attention_decode - sliding window h_kv=4, h_q=32, d=128, float16, llama3 rope."""
...
class TestAttentionDecodeGPU_SlidingWindow_Llama3Rope:
    @pytest.fixture(autouse=True)
    def _target(self):
        self.target = tvm.target.Target("cuda")

    def test_sliding_window_llama3_rope(self):
        fn = _attention_decode(4, 32, 128, "float16", True, ROPE_SCALING_LLAMA3, self.target)
