...
# under the License.
"""Test for _attention_prefill_mla - num_heads=32, v_head_dim=128, qk_nope_head_dim=64, float16, non-causal."""
...
class TestAttentionPrefillMlaGPU_NonCausal:
    @pytest.fixture(autouse=True)
    def _target(self):
        self.target = tvm.target.Target("cuda")

    def test_non_causal(self):
        fn = _attention_prefill_mla(32, 128, 64, "float16", False, self.target)
