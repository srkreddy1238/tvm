...
# under the License.
"""Test for _attention_prefill - GQA h_kv=4, h_q=32, d=128, float16, no sliding window, llama3 rope."""
...
class TestAttentionPrefillGPU_GQA_F16_NoSW_Llama3Rope:
    @pytest.fixture(autouse=True)
    def _target(self):
        self.target = tvm.target.Target("cuda")

    def test_gqa_f16_no_sw_llama3_rope(self):
        fn = _attention_prefill(4, 32, 128, "float16", False, ROPE_SCALING_LLAMA3, self.target)
