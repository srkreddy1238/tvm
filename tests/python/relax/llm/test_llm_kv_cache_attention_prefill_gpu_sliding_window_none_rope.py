...
# under the License.
"""Test for _attention_prefill - sliding window h_kv=4, h_q=32, d=128, float16, no rope."""
...
class TestAttentionPrefillGPU_SlidingWindow_NoneRope:
    @pytest.fixture(autouse=True)
    def _target(self):
        self.target = tvm.target.Target("cuda")

    def test_sliding_window_none_rope(self):
        fn = _attention_prefill(4, 32, 128, "float16", True, ROPE_SCALING_NONE, self.target)
