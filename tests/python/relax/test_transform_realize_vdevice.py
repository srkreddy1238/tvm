    ...
    class Input:
        ...
        def foo(
            ...
            with R.dataflow():
                ...
                x2 = x1
                y2 = y1
                x2 = R.hint_on_device(x2, VDevice(tvm.cpu()))
                lv0 = R.add(x2, y2)
                gv = R.multiply(lv0, z)
                R.output(gv)
            return gv
...
def test_multi_device():
    ...
    class Input:
        ...
        def foo(
            ...
            with R.dataflow():
                lv0 = R.add(x, y)
                lv0 = R.hint_on_device(lv0, VDevice(tvm.cpu()))
...
def test_insert_to_vdevice():
    ...
    class Input:
        ...
        def foo(
            ...
            with R.dataflow():
                lv0 = R.hint_on_device(y, VDevice(tvm.cpu()))
                lv1 = R.add(x, lv0)
                lv2 = R.hint_on_device(lv1, VDevice(tvm.cuda()))
                lv3 = R.add(lv2, lv2)
                lv4 = R.hint_on_device(z, VDevice(tvm.cuda()))
