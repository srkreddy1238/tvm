...
from tvm.tir.tensor_intrin.adreno import get_adreno_wmma_intrin_group
...
@tvm.testing.requires_adreno_vulkan(support_required="compile-only")
def test_coopmat_vec_qcom_extn():
    ...
    def schedule_fn(sch: tir.Schedule):
        compute_blk = sch.get_block("compute")
