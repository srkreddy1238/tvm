...
if(USE_OPENCL)
  ...
  if(USE_OPENCL_EXTN_QCOM)
    find_file(OPENCL_EXTN_HEADER cl_ext_qcom.h HINTS ${USE_OPENCL}/CL ${USE_OPENCL}/include/CL)
    if(NOT OPENCL_EXTN_HEADER)
      message(FATAL_ERROR "Qualcomm Extension Support enabled. \
      But, couldn't find cl_ext_qcom.h in OpenCL SDK Path given: ${USE_OPENCL}")
    endif()
