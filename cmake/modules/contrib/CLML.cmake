...
if(USE_CLML)
    ...
    if (NOT USE_CLML STREQUAL "ON")
        find_file(CLML_VERSION_HEADER cl_qcom_ml_ops.h HINTS ${USE_CLML}/CL ${USE_CLML}/include/CL)
        if(CLML_VERSION_HEADER)
            ...
            message(FATAL_ERROR "OpenCLML is enabled via SDK PATH, \
            but can't find cl_qcom_ml_ops.h")
        endif()
    elseif(USE_CLML_VERSION)
        set(CLML_VERSION_MAJOR ${USE_CLML_VERSION})
    else()
